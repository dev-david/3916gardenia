				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h2 class="alt">Thinking about selling <span class="blackblock"> 3916 Gardenia Place? </span> Let us help! This is YOUR personal team of professionals. Whether you have questions about purchasing or selling, you can rest assured when you have your own Team of Fast Agents backing you.</h2>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							...
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 3916 Gardenia Place</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
								...
								<div class="4u">
									<article class="item">
										...
										<ul>
											...
											<li>List: 5/30/13 - Pending: 6/7/13</li>
								...
								<div class="4u">
									<article class="item">
										...
										<header>
										<h3><strong>3586 Seminary Ave</strong></h3>
										<ul>
											<li>3 Bed - 2 Bath</li>
											<li>1,144 Sq Ft - 3,795 Lot</li>
											<li>List: 6/20/13 - Pending: 7/9/13</li>
											<li>List: $359,000 - SOLD $359,000</li>
										</ul>
									</article>
								</div>
							</div>
